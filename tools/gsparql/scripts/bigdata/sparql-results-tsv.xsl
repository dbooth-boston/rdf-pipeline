...
<!-- 
This stylesheet converts SPARQL results format to TSV format.
It was downloaded on 2013-03-12 from
http://code.google.com/p/callimachus/source/browse/trunk/webapps/callimachus/styles/sparql-results-tsv.xsl?r=1432 
and used by permission per the Apache 2.0 license under which
it was made available:
http://code.google.com/p/callimachus/
This code has not been modified except to add the Apache 2.0 license
at the end.
-->
...
<!--
Apache 2.0 license from http://www.apache.org/licenses/LICENSE-2.0
